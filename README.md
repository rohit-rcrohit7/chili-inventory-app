...
- ✅ Add new items with type, serial, and location
- 🔄 Check-in / Check-out tracking (with responsible person and expected return date)
- 📍 Tracks where items are sent ("Checked Out Location")
- 🕵️ Manual **verification** system with who/when verified
